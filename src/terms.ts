...
export const abs = (ns: Name[], body: Term): Term => ns.reduceRight((t, n) => Abs(n, t), body);
...
export const lets = (ns: [Name, Term][], body: Term): Term => ns.reduceRight((t, [x, v]) => Let(x, v, t), body);
